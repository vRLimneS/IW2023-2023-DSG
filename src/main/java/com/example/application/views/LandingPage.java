...
public class LandingPage extends VerticalLayout {
    ...
    public LandingPage() {
        ...
        login.addClickListener(e -> login.getUI().ifPresent(ui -> ui.navigate(LoginBasic.class)));
        //registro
        Button registro = new Button("Registrarse");
        registro.addClickListener(e -> registro.getUI().ifPresent(ui -> ui.navigate(Registro.class)));
        //tarifas
